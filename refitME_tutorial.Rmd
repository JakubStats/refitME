...
The Framingham heart study data set. We also fit SIMEX models and compare them with MCEM. Computationanl times for both models are also reported.
...
sigma.sq.u <- 0.3 # This gives a reliability ratio of 0.7.
...
for(i in 1:4){
  if (i == 1){
    plot(est$mod, select = i, ylim = c(-0.35, 0.45), xlim = c(0, 6.5), rug = FALSE, col = 3, all.terms = TRUE,
         xlab = xlab.names[i], ylab = "s(Mortaity counts)", lwd = 2, cex.lab = 1.3, cex.axis = 1.3,
         cex.main = 2, font.lab = 1, cex = 1.1)
  ...
  if (i == 2){
    plot(est$mod, select = i, ylim = c(-0.25, 0.3), rug = FALSE, col = 3, all.terms = TRUE,
         xlab = xlab.names[i], ylab = "s(Mortaity counts)", lwd = 2, cex.lab = 1.3, cex.axis = 1.3,
         cex.main = 2, font.lab = 1.1, cex = 1.3)
    for(j in 1:2){
      axis(j, labels = FALSE)
    }
  }
  if (i == 3){
    plot(est$mod, select = i, ylim = c(-0.2, 0.4), rug = FALSE, col = 3, all.terms = TRUE,
         xlab = xlab.names[i], ylab = "s(Mortaity counts)", lwd = 3, cex.lab = 1.3, cex.axis = 1.3,
         cex.main = 2, font.lab = 1.1, cex = 1.3)
    for(j in 1:2){
      axis(j, labels = FALSE)
    }
  ...
  if (i == 4){
    plot(est$mod, select = i, ylim = c(-0.06, 0.08), rug = FALSE, col = 3, all.terms = TRUE,
         xlab = xlab.names[i], ylab = "s(Mortaity counts)", lwd = 2, cex.lab = 1.3, cex.axis = 1.3,
         cex.main = 2, font.lab = 1.1, cex = 1.3)
    for(j in 1:2){
      axis(j, labels = FALSE)
