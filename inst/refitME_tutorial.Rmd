...
The Milan mortality air pollution data set. Here, we fit GAM models via the `mgcv` package where one predictor (daily total suspended particles measurements) is error-contaminated.
...
PPM_MCEM1 <- refitME(PPM_naiv1, sigma.sq.u)
```
